...
public class Settings extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        SettingsNavigation = new javax.swing.JPanel();
        ...
        SettingsScreens.setBackground(new java.awt.Color(0, 153, 153));
        SettingsScreens.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153), 20));
        SettingsScreens.setLayout(new javax.swing.BoxLayout(SettingsScreens, javax.swing.BoxLayout.Y_AXIS));

        Account.setBackground(new java.awt.Color(0, 153, 153));
        ...
        jButton3.setText("Cambiar contaseña");
        ...
        Account.add(jPanel1, java.awt.BorderLayout.CENTER);

        SettingsScreens.add(Account);

        Desing.setBackground(new java.awt.Color(0, 153, 153));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153), 15));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153), 15));
        ...
        Error.add(jPanel3, java.awt.BorderLayout.CENTER);

        SettingsScreens.add(Error);

        add(SettingsScreens, java.awt.BorderLayout.CENTER);

        SettingsNavigation.setBackground(new java.awt.Color(0, 153, 153));
        SettingsNavigation.setLayout(new javax.swing.BoxLayout(SettingsNavigation, javax.swing.BoxLayout.Y_AXIS));

        jPanel4.setBackground(new java.awt.Color(0, 153, 153));
        jPanel4.setLayout(new javax.swing.BoxLayout(jPanel4, javax.swing.BoxLayout.Y_AXIS));

        ButtonGroupSettingsNavigation.add(jRadioButton1);
        jRadioButton1.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
        jRadioButton1.setForeground(java.awt.Color.white);
        jRadioButton1.setText("Cuenta");
        jPanel4.add(jRadioButton1);

        ButtonGroupSettingsNavigation.add(jRadioButton2);
        ...
        SettingsNavigation.add(jButton5);

        add(SettingsNavigation, java.awt.BorderLayout.WEST);
    ...
    private javax.swing.JPanel SettingsNavigation;
